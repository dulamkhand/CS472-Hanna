...
<body>
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				<h4 class="card-title">Name: ${sessionScope.customerName}</h4>
				<br />
				<h5 class="card-subtitle mb-2 text-muted">Gender:
					${sessionScope.gender}</h5>
				<br />
				<h5 class="card-subtitle mb-2 text-muted">
					Category: ${sessionScope.category}
					</h4>
					<br />
					<p class="card-text">Message: ${sessionScope.message}</p>
					<br />
					<br />
					<p>
						Please feel free to <a href="contact" class="card-link">Contact
							Us again</a>
					</p>
					<br />
					<p>
						<a href="contactMessages.jsp" class="card-link">Contact
							Messages</a>
					</p>
			</div>
		</div>
